...
pub struct EditorState {
    ...
    configured_command_completions: Vec<String>,
    command_path_completions: commands::CommandPathCompletions,
...
impl EditorState {
    pub fn new(session: EditorSession) -> Self {
        ...
        let state = Self {
            ...
            configured_command_completions: vec!["colorscheme default".to_string()],
            command_path_completions: commands::CommandPathCompletions::default(),
            status_msg: None,
