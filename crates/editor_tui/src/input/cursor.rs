//! Document cursor controller + viewport scrolling logic for `editor_tui`.
//!
...
//!   `editor_core::motion` so those behaviors are shared across frontends.
//!
//! Design goals:
...
//!
//! This file intentionally does not depend on the rest of `editor_tui::ui` to avoid circular deps.

use editor_core::motion::{Motion, apply_motion_n};
